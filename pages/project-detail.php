...
if (isset($_GET['id'])) {
    $projectInit = $projectService->getProjectByID($_GET['id']);
    $tasks = $taskService->getTasksForProject($projectInit->getProjectID());
}
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content">
                            <h5><?php echo isset($projectInit) ? $projectInit->getName() : null ?></h5>
                        </div>
                    </div>
                </div>
            </div>
